  ...
  return (
    <>
      <style>{`
        ...
        .nav-link.active { color: #3db85a; }
        .nav-btn-outline {
          padding: 8px 18px; border-radius: 8px;
          font-size: 14px; font-weight: 500;
          color: #0D1B2A; border: 1.5px solid #0D1B2A;
      ...
      {mobileOpen && (
        <div style={{
          ...
          <div style={{
            ...
            {user ? (
              <button onClick={handleSignOut} className="mobile-menu-link" style={{ background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', color: '#dc2626' }}>
                Sign Out
              </button>
            ) : (
              <>
