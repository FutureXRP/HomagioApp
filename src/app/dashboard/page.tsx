    ...
    return (
      <div style={{minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8f8f8'}}>
        <div style={{textAlign: 'center'}}>
          ...
          <div style={{fontSize: '18px', fontWeight: 600, marginBottom: '8px'}}>Please sign in</div>
          <a href="/login" style={{color: '#006aff', textDecoration: 'none', fontSize: '15px'}}>Go to Login →</a>
        </div>
      </div>
    )
  }
    ...
    <div style={{minHeight: '100vh', background: '#f8f8f8'}}>
      ...
      <div style={{maxWidth: '1200px', margin: '0 auto', padding: '48px 32px'}}>
        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '32px', flexWrap: 'wrap', gap: '16px'}}>
          ...
          <button onClick={() => window.location.href = '/homes/add'} style={{background: '#006aff', color: '#fff', border: 'none', padding: '12px 24px', borderRadius: '8px', fontSize: '15px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit'}}>
            + Add Home
          </button>
        </div>
        ...
        {homes.length === 0 ? (
          <div style={{background: '#fff', border: '2px dashed #e5e5e5', borderRadius: '16px', padding: '64px 32px', textAlign: 'center'}}>
            ...
            <button onClick={() => window.location.href = '/homes/add'} style={{background: '#006aff', color: '#fff', border: 'none', padding: '14px 32px', borderRadius: '8px', fontSize: '15px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit'}}>
              + Add My First Home
            </button>
          </div>
        ) : (
