    ...
    <>
      ...
      <div style={{minHeight: '100vh', background: '#f7f9fc', fontFamily: 'system-ui, sans-serif'}}>
        ...
        <div style={{maxWidth: '1100px', margin: '0 auto', padding: '52px 32px'}}>
          ...
          <div style={{marginBottom: '44px'}}>
            ...
            <p style={{fontSize: '15px', color: '#6b7280'}}>
              {isNewUser
                ...
                : `You have ${homesCount} home${homesCount !== 1 ? 's' : ''} cataloged. What would you like to do today?`}
            </p>
          </div>
            ...
            <div style={{background: 'linear-gradient(135deg, #006aff 0%, #3b82f6 100%)', borderRadius: '20px', padding: '36px 40px', marginBottom: '40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '24px', flexWrap: 'wrap'}}>
              <div>
                ...
                <div style={{fontSize: '14px', color: 'rgba(255,255,255,0.8)', maxWidth: '420px', lineHeight: 1.6}}>
                  Start building your home's digital twin. Catalog every material, finish, and fixture — and automatically get an Exterior room to track your roof, siding, and windows.
                </div>
              </div>
              <button
          ...
          {/* Feature Grid */}
          <div style={{marginBottom: '44px'}}>
            <div style={{fontSize: '12px', fontWeight: 700, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '16px'}}>
              Platform Features
            </div>
            <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px'}}>
              {FEATURES.map(feature => (
                ...
                >
                  {feature.soon && (
                    <div style={{position: 'absolute', top: '16px', right: '16px', background: '#f3f4f6', color: '#9ca3af', fontSize: '10px', fontWeight: 700, padding: '3px 8px', borderRadius: '20px', letterSpacing: '0.05em'}}>
                      COMING SOON
                    </div>
                  )}
          ...
          {/* Quick Nav */}
          <div style={{background: '#fff', border: '1px solid #e9edf2', borderRadius: '14px', padding: '20px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)'}}>
