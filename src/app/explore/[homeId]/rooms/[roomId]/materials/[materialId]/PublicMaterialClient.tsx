...
export default function PublicMaterialClient({ home, room, material }: {
  home: any, room: any, material: any
}) {
          ...
          <div style={{ background: '#fff', borderRadius: '20px', border: '1px solid #e9edf2', overflow: 'hidden', marginBottom: '16px' }}>
            ...
            <div style={{ padding: '28px 32px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px', flexWrap: 'wrap', marginBottom: '24px' }}>
                <div>
                  <p style={{ fontSize: '12px', fontWeight: 600, color: '#3db85a', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '8px' }}>
                    {home.name || home.address} · {room.name}
                  </p>
            ...
            <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #e9edf2', padding: '24px 28px', marginBottom: '16px' }}>
              ...
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                {material.purchase_url && (
                  <a href={material.purchase_url} target="_blank" rel="noopener noreferrer" className="buy-btn" style={{ background: '#0D1B2A', color: '#fff' }}>
                    Buy This Material
                  </a>
                )}
                {material.affiliate_url && (
                  <a href={material.affiliate_url} target="_blank" rel="noopener noreferrer" className="buy-btn" style={{ background: '#3db85a', color: '#fff' }}>
                    Shop via Affiliate
                  </a>
                )}
              </div>
