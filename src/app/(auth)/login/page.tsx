...
**Important** — after pasting, before you commit, look at line 1 in the editor and confirm it shows exactly:
```
'use client'        <div style={{textAlign: 'center', marginBottom: '32px'}}>
          <a href="/" style={{textDecoration: 'none'}}>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div style={{textAlign: 'right', marginBottom: '24px'}}>
            <button
              ...
              style={{background: 'none', border: 'none', color: '#006aff', fontSize: '13px', cursor: 'pointer', fontFamily: 'inherit'}}
            >
              Forgot password?
            </button>
          </div>
