...
function RoomIcon({ type }: { type: string }) {
  ...
  if (t.includes('bedroom')) return <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="2" y="9" width="20" height="11" rx="2" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5" fill="none"/><path d="M2 14h20M7 14V9M17 14V9" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/></svg>
  if (t.includes('bathroom')) return <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M4 12h16v4a4 4 0 01-4 4H8a4 4 0 01-4-4v-4z" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5" fill="none"/><path d="M4 12V5a2 2 0 014 0v7" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/></svg>
  if (t.includes('kitchen')) return <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="3" y="5" width="18" height="14" rx="2" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5" fill="none"/><path d="M3 10h18M8 10v9M8 5v5" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/></svg>
  if (t.includes('garage')) return <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="2" y="8" width="20" height="13" rx="1.5" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5" fill="none"/><path d="M2 13h20M7 13v8M12 13v8M17 13v8" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/><path d="M5 8L12 3l7 5" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/></svg>
  if (t.includes('exterior')) return <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M3 11L12 3l9 8v9a1 1 0 01-1 1H4a1 1 0 01-1-1v-9z" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5" fill="none"/><path d="M9 21v-6h6v6" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5" fill="none"/></svg>
  return <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="2" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5" fill="none"/><path d="M3 9h18M9 9v12" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/></svg>
}
      ...
      <div style={{ minHeight: '100vh', background: '#f7f9fc', fontFamily: "'DM Sans', system-ui, sans-serif" }}>
        ...
        <nav style={{ background: '#fff', borderBottom: '1px solid #e9edf2', padding: '0 40px', height: '64px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 100 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <button
              onClick={() => window.location.href = `/homes/${homeId}/rooms/add`}
          ...
          <div style={{ background: '#fff', borderRadius: '20px', border: '1px solid #e9edf2', overflow: 'hidden', marginBottom: '24px' }}>
            {homePhoto ? (
              ...
              <div
                ...
                onMouseEnter={e => (e.currentTarget as HTMLDivElement).style.background = '#112236'}
                onMouseLeave={e => (e.currentTarget as HTMLDivElement).style.background = '#0D1B2A'}
              >
                ...
                {photoUploading ? (
                  ...
                  <>
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" opacity="0.4">
                      <path d="M4 26V14l6-6h16l6 6v12a2 2 0 01-2 2H6a2 2 0 01-2-2z" stroke="#fff" strokeWidth="1.5" fill="none"/>
                      <circle cx="18" cy="20" r="4" stroke="#fff" strokeWidth="1.5" fill="none"/>
                    </svg>
                    <div style={{ fontSize: '14px', fontWeight: 600, color: 'rgba(255,255,255,0.6)' }}>Add a home photo</div>
                    <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.35)' }}>Show the exterior of your home</div>
                  </>
                )}
              </div>
            )}
            ...
            {rooms.length === 0 ? (
              <div style={{ background: '#0D1B2A', borderRadius: '12px', padding: '48px 32px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '16px', opacity: 0.4 }}>
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="none"><rect x="3" y="3" width="34" height="34" rx="4" stroke="#fff" strokeWidth="2" fill="none"/><path d="M3 16h34M16 16v21" stroke="#fff" strokeWidth="2"/></svg>
                </div>
                ...
                {rooms.map(room => (
                  <div key={room.id} className="room-card" onClick={() => window.location.href = `/homes/${homeId}/rooms/${room.id}`}
                    ...
                    {room.photo_url ? (
                      ...
                      <div style={{ height: '90px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            ...
            {materials.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '40px 32px', border: '2px dashed #e9edf2', borderRadius: '12px', background: '#fafbfc' }}>
                <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '12px', opacity: 0.3 }}>
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="none"><rect x="4" y="4" width="32" height="32" rx="4" stroke="#1a1a2e" strokeWidth="2" fill="none"/><path d="M4 16h32M16 16v20" stroke="#1a1a2e" strokeWidth="2"/></svg>
                </div>
