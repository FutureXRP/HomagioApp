    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .material-row { display: flex; align-items: center; gap: 14px; padding: 14px 16px; border: 1px solid #f3f4f6; border-radius: 10px; transition: background 0.12s; cursor: pointer; }
      ...
      <div style={{minHeight: '100vh', background: '#f7f9fc', fontFamily: 'system-ui, sans-serif'}}>
        ...
        <div style={{maxWidth: '1100px', margin: '0 auto', padding: '40px 32px'}}>
          ...
          {/* Materials — clicking opens detail page */}
